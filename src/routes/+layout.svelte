...
<footer class="bg-black text-stone-100 text-md px-16 py-8">
	<div class="w-full text-center">
		...
		<div class="mx-auto flex gap-4 justify-center items-center">
			<p>Will Braun</p>
			<a href="https://www.linkedin.com/in/williamhbraun/" target="_blank" class="w-4">
			...
			<a href="https://github.com/willbraun" target="_blank" class="w-4">
